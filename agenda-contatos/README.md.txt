...
Utilização dos conhecimentos obtidos na matéria Estrutura de Dados, no segundo período do curso Ciência da Computação.
...
O executável do programa está disponível na pasta. 

Os comandos para compilar o código no terminal são: 
-gcc src/main.c src/contato.c -Iinclude -o agenda
-./agenda
